...
//		map.put("sword", "게");
//		List<NewsVO> list = mapper.list(map);
...
//	}
	...
	/*
	 * //@Test public void register() { UserVO vo = new UserVO();
	 * vo.setEmail("test3@test.com"); vo.setPwd("pwdaaa"); vo.setName("test");
	 * vo.setGender(1); vo.setBirth(19019); vo.setPhone(010010010);
	 * mapper.insert1(vo); }
	 */
